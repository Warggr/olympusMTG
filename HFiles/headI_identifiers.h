...
const Identifier rid_objtype = 0x3;
const Identifier rid_perm_type = 0x1C;//0b11100;
const Identifier rid_colors_exact = 0x3E0;//0b1111100000;
const Identifier rid_controller = 0x400;
const Identifier rid_tribe = 0x3800;
