...
private:
	...
	Effect_H* effects; //and then the effects. The PreResolvable contains everything necessary to choose targets and put ability onto the stack.
public:
	void setEffects(Effect_H* preRes) { effects = preRes; };
